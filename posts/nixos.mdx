...
Below is an image showcasing my NixOS desktop setup with Hyprland, Waybar, and Stylix customisations. The terminal is configured with a semi-transparent background and a personalized Zsh prompt powered by p10k, providing a minimal yet functional workspace.
<br />
