export const metadata = {
  ...
  date: '2023-10-30',
  summary: 'An investigation into NeuroEvolution of Augmenting Topologies (NEAT) and its ability to solve reinforcement learning situations with fitness and novelty based fitness functions.',
  author: 'Alex Cheetham',
  imageSrc: '/posts/NEUROEV/featured.jpeg',
  topics: ['ml', 'simulation'],
  math: true,
};
