...
function triggerAzureFunction() {
  const url = 'https://spatial-ecology-no-users.azurewebsites.net/api/start?code=U_3nmLOh7QuokxrxjY2MJteSa4b1Id8iqpFhWR5lZHEmAzFu1QaQDw==';
...
const ButtonTimer = () => {
    ...
    const handleClick = () => {
      if (isActive) {
        ...
        setIsActive(true);
        setClient(new Ably.Realtime.Promise({
          authUrl: '/token',
          authMethod: 'POST',
          clientId: "id_123"
        }));
